...
export class GrantCreatePermission extends RequestBase <undefined,ICreatePermissionInputs>
{
    ...
    information= 
    {
        description: "Grant Create Permissions to a Work Type",
        displayName: "Grant Create Permissions",
        created: "2023-Aug-3",
    ...
    get path()
    {
       ...
       // https:///api/modeller/sharedoTypes/instruction-b2c-enquiry-dispute-claimant/createPermission/user/af101f7b-5c31-439d-9120-c970359573bd
       // https:///api/modeller/sharedoTypes/instruction-b2c-enquiry-dispute-claimant/createPermission/user/e35935ac-006c-4d5f-bb34-17246220b06b
