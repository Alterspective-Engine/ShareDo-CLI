/**
 * Remote Authentication Utilities (Experimental/Legacy)
 *
 * This file contains commented-out and experimental code for remote authentication flows (e.g., Auth0) in VS Code.
 * Not currently active in the extension, but kept for reference and future development.
 */
...
//                 `https://${AUTH0_DOMAIN}/oauth/token`, postData,
//                 {
...
//             const { access_token, refresh_token } = await response.data() as any;
...
//         const { access_token } = await response.data as any;
