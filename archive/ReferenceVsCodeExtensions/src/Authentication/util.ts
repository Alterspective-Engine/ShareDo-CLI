/**
 * VS Code Utility Functions for Promises and Events
 *
 * Provides helpers for working with VS Code events and promises, including adapters for event-to-promise conversion.
 */
